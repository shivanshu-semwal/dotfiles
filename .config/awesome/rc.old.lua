...
beautiful.init("/home/antihero/.config/awesome/themes/default/theme.lua")
-- beautiful.init("/home/antihero/.config/awesome/themes/gtk/theme.lua")
-- beautiful.init("/home/antihero/.config/awesome/awesome-themes/dwm/theme.lua")
...
globalkeys = gears.table.join(
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("/home/antihero/Scripts/volume.sh -inc") end),
    awful.key({ }, "XF86AudioLowerVolume", function () awful.util.spawn("pactl set-sink-volume @DEFAULT_SINK@ -1%") end),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("pactl set-sink-mute @DEFAULT_SINK@ toggle") end),
    awful.key({ }, "XF86AudioRaiseVolume", function () awful.util.spawn("pactl set-source-mute @DEFAULT_SOURCE@ toggle") end),
    ...
    awful.key({modkey}, "d", function() awful.spawn("/home/antihero/.config/rofi/launchers/launcher.sh") end, {description = "run prompt", group = "launcher"}),
